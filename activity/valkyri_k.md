...
| 2026-08-11 | J26112: add Director to 3 shoot event descs (calendar only) | Patched desc `Director: Kary, Erase, Atlas` on Day1/2/3 ✅; master job log untouched per request. Flagged「Erase」not in team record (added verbatim, asked if typo) |
